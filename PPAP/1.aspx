...
<body>
    <form id="form1" runat="server">
        <div aria-atomic="False" aria-disabled="False" aria-grabbed="true">
            ...
            <asp:Label ID="L2" runat="server" Text="小菜一盤30元"></asp:Label><br />
            <asp:DropDownList ID="DropDownList1" runat="server" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" Height="40px" Width="100px">
            ...
            <asp:Label ID="Label1" runat="server" Text="飲料一瓶25元"></asp:Label><br />
